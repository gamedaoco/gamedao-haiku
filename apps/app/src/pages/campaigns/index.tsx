		...
		<Layout showHeader showFooter showSidebar title={t('labels:campaigns')}>
			...
			<Grid item>
				...
				<Typography variant="body1" sx={{ maxWidth: { sx: '100%', md: '75%', lg: '50%' } }}>
					Support existing campaigns to take part in product development and governance. To create a campaign
					for your own ideas, start by creating your own organization or join an existing organization to take
					part in their governance to initiate a campaign.
				</Typography>
			</Grid>
