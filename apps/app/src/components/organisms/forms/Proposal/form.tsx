...
} from 'components/organisms/forms/Proposal/components/description'
import { Majority } from 'components/organisms/forms/Proposal/components/majority'
import { Type } from 'components/organisms/forms/Proposal/components/type'
