			...
			if (state) {
				...
				result.events.forEach(({ event: { data, method, section } }) => {
					if (section === 'control' && method === 'OrgCreated') {
						...
						console.log('org created with id', id)
						setOrgId(id)
						// push('/collectives/' + id + '/dashboard')
					}
				})
			}
		},
					...
					>
						<Stack direction="row" alignItems="center" spacing={2}>
							...
							<Typography>
								...
								To launch your collective a minimum collateral of 100 GAME is required. Higher deposits
						...
						>
							...
							<Button
								size="large"
								variant="contained"
								sx={{ whiteSpace: 'nowrap', p: '1rem 2rem' }}
								disabled={!tx && !createEnabled}
