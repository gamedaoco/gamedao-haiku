...
export function Name({ name, setName, description, setDescription, url, setUrl, location, setLocation, tags, setTags }: ComponentProps) {
	...
	return (
		<BaseForm title={'Describe your Collective'} error={errorState}>
			<TextField name="name" fullWidth onChange={handleNameChange} value={name} label="Name" required variant="outlined" error={!!errorState} />
			<TextField
				name="description"
				fullWidth
				multiline
			...
			/>
			<hr />
			<TextField name="url" onChange={handleUpdate} fullWidth value={url} label="Website" placeholder="https://coolsite.xyz" variant="outlined" />
			<TextField name="location" onChange={handleUpdate} fullWidth value={location} label="Location" placeholder="" variant="outlined" />
			<TextField
				inputRef={tagRef}
				fullWidth
