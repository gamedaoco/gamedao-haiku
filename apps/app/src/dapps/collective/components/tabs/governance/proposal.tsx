...
import { ProposalStatusChip } from 'components/molecules/ProposalStatusChip'
			...
			<Stack spacing={2} flex={1}>
				<Stack component={Paper} padding={4} spacing={3}>
					...
					>
						...
						<NavLink
							href={`https://polkadot.js.org/apps/?rpc=${encodeURIComponent(chain.toLowerCase())}#/explorer/query/${proposal.createdAtBlock}`}
							external={true}
						>
