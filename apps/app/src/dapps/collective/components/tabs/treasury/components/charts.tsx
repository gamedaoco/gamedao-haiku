...
// Subscriptions
import { getCurrentBalanceSubscription, getHistoricBalanceSubscription, HistoricBalanceItem } from './mock-data'
			...
			<Grid item xs={8}>
				<Stack component={Paper} padding={4} spacing={6} sx={{ boxShadow: 'none' }}>
					...
					<Grid container spacing={3} style={{ marginTop: 0 }}>
						...
						<Grid item xs={3}>
							<ChartLabel
								name={`${t('page:organizations:treasury:total')} ${t('page:organizations:treasury:income')}`}
								color={theme.palette.success.main}
							></ChartLabel>
						</Grid>
						<Grid item xs={3}>
							<ChartLabel
								name={`${t('page:organizations:treasury:total')} ${t('page:organizations:treasury:outgoing')}`}
								color={theme.palette.warning.main}
							></ChartLabel>
						</Grid>
					</Grid>
