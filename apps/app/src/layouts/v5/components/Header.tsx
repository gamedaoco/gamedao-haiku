...
export function Header({ onSidebarOpen, sidebarOpen, noContainer, hideDApps }: ComponentProps) {
	...
	const Network = () => {
		return (
			<Chip
				label={connected ? 'private' : 'disconnected'}
				// variant="outlined"
				size="small"
		...
		>
			...
			<Toolbar
				sx={{
					...
					borderBottom: `1px solid ${theme.palette.grey[500_32]}`, //noContainer ? 0 : `1px solid ${theme.palette.grey[500_32]}`,
