...
export function Header() {
	...
	useEffect(() => {
		// const composedBalance = totalBalance - displayBalance
		setDisplayBalance(totalBalance.toFixed(2))
	}, [totalBalance, displayBalance])

	return (
		<Grid container justifyContent="space-between" alignItems="middle" spacing={3}>
			<Grid
				item
				sx={{
					alignItems: {
