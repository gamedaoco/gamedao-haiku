...
import { Collectable as CollectableInterface } from '@gamedao/core/@types/collectable'
...
import { ModelDialog } from 'components/molecules/Collectable/components/modelDialog'
