...
import { Typography, Grid, TextField, FormControlLabel, FormControl, InputLabel, Checkbox, Button, Select, Paper, Box, MenuItem, Autocomplete, Container, FormHelperText, Stepper, Step, StepLabel } from '@mui/material'
import Image from '@mui/icons-material'
import { Image16to9 } from 'src/utils/Image16to9'
...
import FileDropZone from './defaultComponents/FileDropZone'
import data from 'lib/data'
import { toZeroAddress, isValidZeroAddress } from 'src/utils/helper'
...
export function FormDao(props) {
  ...
  const accounts = ['3ZBh2L6YhhmBRWG8UavtA7zJnFcpTemUmSrL8LfH43Rym2WJ', '3HED2L6YhhmBRWG8UavtA7zJnFcpTemUmSrL8LfH43Rym2WJ']
  ...
  const validationSchema = Yup.object().shape({
    ...
    controller_account: Yup.string().required('Controller account is required').test('This is zero-address', 'This is not valid zero-address', (value) => {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                {...register('controller_account')}
                options={accounts}
                onChange={(e, options) => {console.log('onchange',e, options);setValue('controller_account',options, {shouldValidate: true})}}
                renderInput={(params) => (
                  <TextField
                    {...params}
