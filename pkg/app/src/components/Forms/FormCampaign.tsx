...
import { Typography, Grid, TextField, FormControlLabel, FormControl, InputLabel, Checkbox, Button, Select, Paper, Box, MenuItem, Autocomplete, Container, FormHelperText, Stepper, Step, StepLabel, Divider, InputAdornment } from '@mui/material'
...
export function FormCampaign(props) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    admin: Yup.string().required('Required').test('is zero-address', 'is not valid zero-address', (value) => isValidZeroAddress(value)),
        ...
        <Grid container spacing={3} component="form">
          ...
          <Grid item xs={12} md={6}>
            <Autocomplete
              ...
              disableClearable
              fullWidth
              options={accounts.map((a) => toZeroAddress(a))}
