...
export type OrganizationsPaginationSubscription = { readonly __typename?: 'subscription_root', readonly organization: ReadonlyArray<{ readonly __typename?: 'organization', readonly id: string, readonly access: string, readonly creator: string, readonly organization_metadata?: { readonly __typename?: 'organization_metadata', readonly name: string, readonly description: string, readonly logo: string } | null, readonly organization_members: ReadonlyArray<{ readonly __typename?: 'organization_member', readonly address: string }> }> };
 ...
 * });
 */
export function useSuccessfulCampaignByOrganisationIdSubscription(baseOptions: Apollo.SubscriptionHookOptions<SuccessfulCampaignByOrganisationIdSubscription, SuccessfulCampaignByOrganisationIdSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<SuccessfulCampaignByOrganisationIdSubscription, SuccessfulCampaignByOrganisationIdSubscriptionVariables>(SuccessfulCampaignByOrganisationIdDocument, options);
      }
...
export const OrganizationsPaginationCountDocument = gql`
  ...
  organization_aggregate(
    where: {organization_metadata: {_or: [{name: {_ilike: $searchQuery}}, {description: {_ilike: $searchQuery}}]}}
  ) {
    aggregate {
      count
    }
