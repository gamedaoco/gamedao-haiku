 ...
 */
export const forSaleToBigInt = (forsale: string | number | bigint, systemProperties: ISystemProperties): bigint => {
 ...
 * @param systemProperties
 */
export const bigIntPriceToNumber = (price: bigint | string | number, systemProperties: ISystemProperties) => {
