...
export const ExtensionProvider = ({ children, autoInitialiseExtension, extensionName }: ExtensionProviderProps) => {
	...
	return <ExtensionContext.Provider value={{ state, dispatch, extensionName }} children={children} />
}
