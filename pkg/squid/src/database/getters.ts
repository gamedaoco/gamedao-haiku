import {
	Organization, OrganizationMember, OrganizationMetadata,
	CampaignContributor, Campaign, Proposal, Voting, ProposalVoter
} from '../model';
...
function getCampaignContributor(store: Store, campaignId: string, contributor: string): Promise<CampaignContributor | null> {
...
export {
	getOrg, getOrgMember, getOrgMetadata, getCampaign,
	getCampaignContributor, getProposal, getVoting, getProposalVoter
};
