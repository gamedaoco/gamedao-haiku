...
export class ControlFundsSpendedEvent {
  ...
  get asV61(): {orgId: v61.H256, beneficiary: v61.AccountId32, amount: bigint, currencyId: v61.CurrencyId, blockNumber: number} {
    assert(this.isV61)
  ...
  get asLatest(): {orgId: v61.H256, beneficiary: v61.AccountId32, amount: bigint, currencyId: v61.CurrencyId, blockNumber: number} {
    deprecateLatest()
    return this.asV61
  }
}
...
export class ControlOrgCreatedEvent {
   ...
   * Org was successfully created.
   */
  get asV61(): {orgId: v61.H256, creator: v61.AccountId32, treasuryId: v61.AccountId32, createdAt: number, realmIndex: bigint} {
    assert(this.isV61)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {orgId: v61.H256, creator: v61.AccountId32, treasuryId: v61.AccountId32, createdAt: number, realmIndex: bigint} {
    deprecateLatest()
    return this.asV61
  }
}
...
export class ControlOrgUpdatedEvent {
  ...
  get asV61(): {orgId: v61.H256, primeId: (v61.AccountId32 | undefined), orgType: (v61.OrgType | undefined), accessModel: (v61.AccessModel | undefined), memberLimit: (number | undefined), feeModel: (v61.FeeModel | undefined), membershipFee: (bigint | undefined), blockNumber: number} {
    assert(this.isV61)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {orgId: v61.H256, primeId: (v61.AccountId32 | undefined), orgType: (v61.OrgType | undefined), accessModel: (v61.AccessModel | undefined), memberLimit: (number | undefined), feeModel: (v61.FeeModel | undefined), membershipFee: (bigint | undefined), blockNumber: number} {
    deprecateLatest()
    return this.asV61
  }
}
...
export class FlowCreatedEvent {
   ...
   * Campaign was successfully created.
   */
  get asV61(): {campaignId: v61.H256, creator: v61.AccountId32, admin: v61.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    assert(this.isV61)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {campaignId: v61.H256, creator: v61.AccountId32, admin: v61.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    deprecateLatest()
    return this.asV61
  }
}
...
export class SignalCreatedEvent {
  ...
  get asV61(): {account: v61.AccountId32, proposalId: v61.H256, orgId: v61.H256, campaignId: (v61.H256 | undefined), amount: (bigint | undefined), start: number, expiry: number} {
    assert(this.isV61)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {account: v61.AccountId32, proposalId: v61.H256, orgId: v61.H256, campaignId: (v61.H256 | undefined), amount: (bigint | undefined), start: number, expiry: number} {
    deprecateLatest()
    return this.asV61
  }
}
...
export class SignalVotedEvent {
  ...
  get asV61(): {account: v61.AccountId32, proposalId: v61.H256, voted: boolean, yes: bigint, no: bigint, votePower: bigint} {
    assert(this.isV61)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {account: v61.AccountId32, proposalId: v61.H256, voted: boolean, yes: bigint, no: bigint, votePower: bigint} {
    deprecateLatest()
    return this.asV61
  }
}
