...
export class ControlFundsSpendedEvent {
	...
	get isV60(): boolean {
		return (
			...
			'bceb89f4c64eff5d47f54b026422201e4dde27058f479eb251ee1eb37fddd4f9'
		);
	}

	get asV60(): {
		orgId: v60.H256;
		beneficiary: v60.AccountId32;
		amount: bigint;
		currencyId: v60.CurrencyId;
		blockNumber: number;
	} {
		assert(this.isV60);
...
export class ControlOrgCreatedEvent {
	...
	get asV60(): {
		orgId: v60.H256;
		creator: v60.AccountId32;
		treasuryId: v60.AccountId32;
		createdAt: number;
		realmIndex: bigint;
	} {
		assert(this.isV60);
