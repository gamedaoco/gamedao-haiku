...
export class ControlFundsSpendedEvent {
  ...
  get isV62(): boolean {
    return this.ctx._chain.getEventHash('control.FundsSpended') === '099c5be51a66396abb273e830e2058b941aad39f3071d1634c96f9b293f58a04'
  }

  get asV62(): {orgId: v62.H256, beneficiary: v62.AccountId32, amount: bigint, currencyId: v62.CurrencyId, blockNumber: number} {
    assert(this.isV62)
  ...
  get asLatest(): {orgId: v62.H256, beneficiary: v62.AccountId32, amount: bigint, currencyId: v62.CurrencyId, blockNumber: number} {
    deprecateLatest()
    return this.asV62
  }
}
...
export class ControlOrgCreatedEvent {
   ...
   * Org was successfully created.
   */
  get asV62(): {orgId: v62.H256, creator: v62.AccountId32, treasuryId: v62.AccountId32, createdAt: number, realmIndex: bigint} {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {orgId: v62.H256, creator: v62.AccountId32, treasuryId: v62.AccountId32, createdAt: number, realmIndex: bigint} {
    deprecateLatest()
    return this.asV62
  }
}
...
export class ControlOrgUpdatedEvent {
  ...
  get asV62(): {orgId: v62.H256, primeId: (v62.AccountId32 | undefined), orgType: (v62.OrgType | undefined), accessModel: (v62.AccessModel | undefined), memberLimit: (number | undefined), feeModel: (v62.FeeModel | undefined), membershipFee: (bigint | undefined), blockNumber: number} {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {orgId: v62.H256, primeId: (v62.AccountId32 | undefined), orgType: (v62.OrgType | undefined), accessModel: (v62.AccessModel | undefined), memberLimit: (number | undefined), feeModel: (v62.FeeModel | undefined), membershipFee: (bigint | undefined), blockNumber: number} {
    deprecateLatest()
    return this.asV62
  }
}
...
export class FlowCreatedEvent {
   ...
   * Campaign was successfully created.
   */
  get asV62(): {campaignId: v62.H256, creator: v62.AccountId32, admin: v62.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {campaignId: v62.H256, creator: v62.AccountId32, admin: v62.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    deprecateLatest()
    return this.asV62
  }
}
...
export class SignalCreatedEvent {
  ...
  get asV62(): {account: v62.AccountId32, proposalId: v62.H256, orgId: v62.H256, campaignId: (v62.H256 | undefined), amount: (bigint | undefined), start: number, expiry: number} {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {account: v62.AccountId32, proposalId: v62.H256, orgId: v62.H256, campaignId: (v62.H256 | undefined), amount: (bigint | undefined), start: number, expiry: number} {
    deprecateLatest()
    return this.asV62
  }
}
...
export class SignalVotedEvent {
  ...
  get asV62(): {account: v62.AccountId32, proposalId: v62.H256, voted: boolean, yes: bigint, no: bigint, votePower: bigint} {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {account: v62.AccountId32, proposalId: v62.H256, voted: boolean, yes: bigint, no: bigint, votePower: bigint} {
    deprecateLatest()
    return this.asV62
  }
}
