...
import { Content, validationSchema as contentValidationSchema } from './components/content'
import { Name, validationSchema as nameValidationSchema } from './components/name'
import { Settings, getValidationSchema as getSettingsValidationSchema } from './components/settings'
